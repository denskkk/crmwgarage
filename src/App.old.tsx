...
import { UserCircle, Plus, CheckCircle2, Circle, Calendar, TrendingUp, X, Edit2, Trash2, Save, LogIn, LogOut, Clock, Filter, Shield, Eye } from 'lucide-react';
...
export default function EmployeeInspectionSystem() {
  ...
  const [employees, setEmployees] = useState([
    ...
    {
      id: 184469,
      name: "Борченко Костянтин",
      position: "Топливщик Т|1|",
      department: "Топливщик Т|1|",
      checklist: [...defaultChecklist],
      inspections: []
    },
    {
      id: 185745,
      name: "Беденков Микола",
      position: "Топливщик Т|3|",
      department: "Топливщик Т|3|",
      checklist: [...defaultChecklist],
      inspections: []
    },
    {
      id: 185781,
      name: "Чернишов Євген",
      position: "Топливщик Т|2|",
      department: "Топливщик Т|2|",
      checklist: [...defaultChecklist],
      inspections: []
    },
    {
      id: 190889,
      name: "Резниченко Сергій",
      position: "Топливщик Т|1|",
      department: "Топливщик Т|1|",
      checklist: [...defaultChecklist],
      inspections: []
    },
    {
      id: 193789,
      name: "Гузенко Даніїл",
      position: "Приймальник агрегатів",
      department: "Склад",
      checklist: [...defaultChecklist],
      inspections: []
    },
    {
      id: 194988,
      name: "Маклашевський Сергій",
      position: "Менеджер з продажу",
      department: "Менеджери",
      checklist: [...defaultChecklist],
      inspections: []
    },
    {
      id: 205433,
      name: "Шелест Анатолій",
      position: "Топливщик Т|1|",
      department: "Топливщик Т|1|",
      checklist: [...defaultChecklist],
      inspections: []
    ...
    {
      id: 254624,
      name: "Литвинов Олексій",
      position: "Ремонтник електроніки",
      department: "Технічні спеціалісти",
      checklist: [...defaultChecklist],
      inspections: []
    },
    {
    ...
    {
      id: 260042,
      name: "Алексєєва Валентина",
      position: "Бухгалтер ФОП",
      department: "Бухгалтерія",
      checklist: [...defaultChecklist],
      inspections: []
    },
    ...
    {
      id: 264682,
      name: "Щукін Володимир",
      position: "Нач. відділу |7|РОМ|",
      department: "Керівництво",
      checklist: [...defaultChecklist],
      inspections: []
    },
    {
      ...
      department: "Автомеханіки",
      checklist: [...defaultChecklist],
      inspections: []
    },
    {
      id: 273351,
      name: "Кортунова Тетяна",
      position: "Бухгалтер ТОВ",
      department: "Бухгалтерія",
      checklist: [...defaultChecklist],
      inspections: []
    },
  ...
  const handleLogin = () => {
    setLoginError("");
    console.log("Спроба входу:", { loginUsername, loginPassword });
    console.log("Доступні користувачі:", users);
